...
{
public:
    static std::string Online(WiFiSSLClient &client, char *ca, std::string &host, std::string &remoteDeviceId, std::string &token)
    {
    ...
    static AuthResponse Auth(WiFiSSLClient &client, char *ca, std::string &host, std::string &postBody)
    {
    ...
    static void CheckSwitchState(WiFiSSLClient &client, char *ca, std::string &host, std::string &token, std::string &remoteDeviceId, std::vector<ItemhubPin> &pins)
    {
    ...
    static void SendSensor(WiFiSSLClient &client, char *ca, std::string &host, std::string &token, std::string &remoteDeviceId, std::vector<ItemhubPin> &pins)
    {
    ...
    static std::string Send(WiFiSSLClient &client, char *ca, std::string &host, char *method, std::string &path, std::string &postBody, std::string &token)
    {
        std::string result = "";
        client.setRootCA((unsigned char *)ca);
